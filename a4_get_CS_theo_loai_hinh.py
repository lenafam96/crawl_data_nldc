...
for date in date_range:
    ...
    url = f"https://www.nsmo.vn/Dashboard/GetBcsxChartDataCongSuatTheoLoaiHinh?ngay={date_str}"
    try:
    ...
    data_for_df = {date_str: time_hours}
...
final_result_df.to_excel("Phan_bo_CS_theo_loai_hinh_2021_2026.xlsx")
print("Finished")